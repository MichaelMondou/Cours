...
namespace GraphX
{
    public class Vertex : GraphObject
    {
        ...
        public static readonly Color hoveredColor = Color.Orange;
        public static readonly Color selectedColor = Color.OrangeRed;
        ...
        public Vertex(Point p, bool temporary) : base(defaultWidth, defaultColor, defaultColor)
        {
            if (!temporary)
            {
                Id = nextId++;
