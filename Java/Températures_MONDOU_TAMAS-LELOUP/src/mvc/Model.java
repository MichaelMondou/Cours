...
/**
 * Modèle contenant les données à afficher ainsi que les différentes méthodes de
...
public class Model extends Observable {
	...
	/**
	 * Température principale de l'application.
	 */
	...
	/**
	 * Permet de modifier la valeur de la température en fonction du scroll.
	 */
