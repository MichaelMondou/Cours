...
/**
 * Classe abstraite permettant de préciser les éléments d'une sous-fenêtre avec
 * contrôle par boutons de la température.
 */
public abstract class ViewButton extends View {

	/**
	 * Le champ dans lequel la température est affichée.
	 */
	private JTextField display;

	/**
	 * Le panneau contenant les différents boutons.
	 */
	...
	/**
	 * Permet l'ajout d'un écouteur sur la valeur de la température indiquée
	 * dans le champ.
	 */
